...
import {
  TranslationsBackupsDto,
  TranslationsCheckedDto,
  TranslationsDto,
} from "../helpers/dto";
import {
  genericActions,
...
const actions = {
  ...
  ...genericActions<TranslationsDto, TranslationDispatch>(
    "/translations",
    "id"
  ),
  doUpdateChecked:
    (
      ids: number[],
      values: Omit<Omit<TranslationsCheckedDto, "ids">, "accountId">
    ) =>
    async (
