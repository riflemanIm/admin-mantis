...
const EditClinicSpecialization = (): JSX.Element => {
  ...
  const { current, specializations, saveLoading } =
    useClinicSpecializationState();
  ...
  const saveData = () => {
    actions.doUpdate(Number(clinicId))(
      ...
      () => {
        ...
        navigate(`/app/clinic/${clinicId}/specialization`);
      },
      (errorMessage: string) => {
      ...
      <Box display="flex" flexDirection="column" width={600}>
        ...
        >
          <InputLabel id="demo-simple-select-outlined-label">
            {t("CLINICSPECIALIZATION.FIELDS.specializationId")}
          </InputLabel>
          <Select
        ...
        <EditorButtons
          width={600}
          onCancel={() => navigate(`/app/clinic/${clinicId}/specialization`)}
